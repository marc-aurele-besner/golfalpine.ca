...
import { FormState } from '../components/forms/Reservation'
import { ContactFormState } from '../components/forms/NousEcrire'
...
export const getReservationFormErrors = (formData: FormState) => {
